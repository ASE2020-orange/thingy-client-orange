    ...
    <b-container fluid>
      <b-row class="vh-100 text-center" align-v="center">
        <b-col>
          ...
          <div v-else>
            <b-button class="bg-primary btn-lg" v-on:click="new_game"
      ...
      <div class="fluid-container footer">
        <p>
          <small>
            ...
            <br />Team members: Sergiy Goloviatinski, Fabien Vorpe, Ludovic
            Herbelin, Raphaël Margueron <br />Icons &copy; by Aman from the Noun
            Project
          </small>
        </p>
      </div>
